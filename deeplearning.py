...
INPUT_WIDTH =  640
INPUT_HEIGHT = 640
net = cv2.dnn.readNetFromONNX('C:/Users/prath/Desktop/final yearproj/proj1/MODULE-WEBAPP/static/model/best.onnx')
...
# Example usage:
# Define 'frames' as a list of frames from the video
# Define 'detections_list' as a list of detections for each frame
# boxes_np_list, confidences_np_list, index_list = non_maximum_suppression_video(frames, detections_list)
...
def real_time_object_detection(path,filename):
